...
Empieza una [nueva discusión](https://github.com/josantonius/php-http-status-code/discussions/new) y selecciona
...
abre una [nueva discusión](https://github.com/josantonius/php-http-status-code/discussions/new) en la categoría
...
[repositorio](https://github.com/josantonius/php-http-status-code). O mejor aún, puedes
...
[Envía un nuevo _issue_](https://github.com/josantonius/php-http-status-code/issues/new) para reportar un error.
...
1. Busca en [GitHub](https://github.com/josantonius/php-http-status-code/pulls) si existe algún tema relacionado
para asegurarte que no esté repetido.

1. [Bifurca](https://github.com/josantonius/php-http-status-code/fork) el repositorio a tu propia cuenta de GitHub.
...
1. En GitHub, envía un [_pull request_](https://github.com/josantonius/php-http-status-code/compare/main..)
hacia `php-http-status-code:main`.
